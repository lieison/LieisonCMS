		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-6 col-sm-6">
					<!-- INICIO DEL SISTEMA PARA VER LAS VISITAS -->
					<div class="portlet solid bordered grey-cararra">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-bar-chart-o"></i>Visitas del sitio web
							</div>
							<div class="actions">
				...
				<div class="col-md-6 col-sm-6">
					...
					<div class="portlet solid grey-cararra bordered">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-bullhorn"></i>HOLA COMO ESTAS
							</div>
							<div class="actions">
